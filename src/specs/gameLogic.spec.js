...
describe('nextTurnState', () => {
  it('should accept 2 args: grid and player', () => {
    expect(nextTurnState.length).toBe(2);

    const mockNextTurnState = jest.fn(nextTurnState);
    mockNextTurnState([], 'X');
    expect(mockNextTurnState.mock.calls[0].length).toBe(2);
  });
